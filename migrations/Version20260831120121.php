 ...
 */
final class Version20260831120121 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE destination (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, country VARCHAR(100) NOT NULL, type VARCHAR(30) NOT NULL, description LONGTEXT NOT NULL, category_id INT NOT NULL, INDEX IDX_3EC63EAA12469DE2 (category_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
